...
def save_video_met():
    ...
    """
    # 分享
    os.system("adb shell input tap 674 985")
    #poco('com.ss.android.ugc.aweme:id/cp_').click()
    #poco('com.ss.android.ugc.aweme:id/chc').wait_for_appearance(10)
    time.sleep(3)

    # 保存到本地
    os.system("adb shell input tap 170 1103")
    #poco("com.ss.android.ugc.aweme:id/coi").click()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            screen_name = get_screen_shot_part_img('temp%d.jpg' % recognite_count)
